    ...
    <div>
      <div class="admin-user-info">
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column align="center" label="操作">
            <template slot-scope="scope">
              ...
              <el-button size="mini" type="primary" @click="handleSet(scope.$index, scope.row)"
                         style="margin-right: 10px">设置角色
              </el-button>
        ...
        <el-dialog :close-on-click-modal="false" :title="dialog.title" :visible.sync="dialog.visible">
          <el-form ref="dataForm" :model="dialog.data" :rules="dialog.rules" label-position="left" label-width="100px"
