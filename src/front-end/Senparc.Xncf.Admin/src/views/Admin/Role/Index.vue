  ...
  <div class="el-main">
    <div class="admin-role">
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-button size="mini" type="primary" @click="handleRole(scope.$index, scope.row)" style="margin-right: 10px">
              权限
            </el-button>
      ...
      <el-dialog :title="'为  ' + au.title + '  角色授权'" :visible.sync="au.visible" :close-on-click-modal="false">
        <el-tree ref="tree" :data="allMenu" show-checkbox node-key="id" :props="defaultProps"
