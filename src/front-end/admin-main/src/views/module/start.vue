            ...
            <ul>
              ...
              <li v-if="data.xncfModule.version !== data.xncfRegister.version">
                ...
                <el-button size="mini" @click="updataVersion">
                  <em class="fa fa-gift"></em>立即更新</el-button
                >
              </li>
              <li>
                <el-tooltip
              ...
              <li>
                ...
                >
                  <el-button
                    ...
                    @click="updataState('1')"
                  >
                    <em class="glyphicon glyphicon-flash"></em> 开启</el-button
                  >
                  <p class="red">
                ...
                <template v-if="data.xncfModule.state === 1">
                  <el-button
                    ...
                    @click="updataState('0')"
                  >
                    <em class="glyphicon glyphicon-off"></em> 关闭</el-button
                  >
                </template>
              </li>
              <li>
