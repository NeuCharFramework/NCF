...
namespace Senparc.Xncf.CodeBuilder.Services
{
    ...
    {
        public CategoryService(IRepositoryBase<Category> repo, IServiceProvider serviceProvider)
        ...
        {
            return GetFullList(_ => _.TypeId.ToString() == typeId, z => z.Id, OrderingType.Ascending).ToList();
        }
