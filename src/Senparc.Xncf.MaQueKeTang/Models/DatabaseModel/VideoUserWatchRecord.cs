...
/// </summary>
    ...
    [Table(Register.DATABASE_PREFIX + nameof(VideoUserWatchRecord))]//必须添加前缀，防止全系统中发生冲突
    [Serializable]
    public class VideoUserWatchRecord : EntityBase<int>
    {
    public VideoUserWatchRecord()
    {
           this.UserId=0;
       this.CourseId=0;
       this.VideoId=0;
       this.WatchSeconds=0;
       this.WatchedAt=DateTime.Now;;
       this.Flag=false;
    ...
    public VideoUserWatchRecord(AddOrUpdateVideoUserWatchRecordReq req)
    {
           this.UserId= req.UserId;
       this.CourseId= req.CourseId;
       this.VideoId= req.VideoId;
       this.WatchSeconds= req.WatchSeconds;
       this.WatchedAt= req.WatchedAt;
       this.Flag= req.Flag;
