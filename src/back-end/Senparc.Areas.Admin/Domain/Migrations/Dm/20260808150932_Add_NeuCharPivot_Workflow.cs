/*----------------------------------------------------------------
    ...
    文件名：20260808150932_Add_NeuCharPivot_Workflow.cs
    文件功能描述：数据库迁移与模型快照
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRequirement = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
                    LayoutSchemaJson = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
                    ...
                    LastGeneratedAt = table.Column<DateTime>(type: "TIMESTAMP", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UiSchemaJson = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
                    DefaultParametersJson = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParametersJson = table.Column<string>(type: "NVARCHAR2(32767)", nullable: true),
