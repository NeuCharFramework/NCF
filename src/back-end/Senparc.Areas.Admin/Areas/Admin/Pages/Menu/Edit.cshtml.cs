...
namespace Senparc.Areas.Admin.Areas.Admin.Pages
{
    public class MenuEditModel : BaseAdminPageModel
    {
        ...
        public async Task<IActionResult> OnPostDeleteButtonAsync(string buttonId)
        {
            ...
            _auditLogService.CreateAuditLogInfo(HttpContext.Session.GetString("userName"), IPAddressController.GetClientUserIp(HttpContext.Request.HttpContext), "删除菜单", DateTime.Now.ToString());
            return Ok(true);
        }
        ...
        public async Task<IActionResult> OnPostAddMenuAsync([FromBody]SysMenuDto sysMenu)
        {
            ...
            //_auditLogService.CreateAuditLogInfo(HttpContext.Session.GetString("userName"), IPAddressController.GetClientUserIp(HttpContext.Request.HttpContext), "添加菜单", DateTime.Now.ToString());
            return Ok(entity.Id);
        }
        ...
        public async Task<IActionResult> OnPostAsync([FromBody]SysMenuDto sysMenuDto)
        {
            ...
            _auditLogService.CreateAuditLogInfo(HttpContext.Session.GetString("userName"), IPAddressController.GetClientUserIp(HttpContext.Request.HttpContext), "添加/编辑菜单", DateTime.Now.ToString());
