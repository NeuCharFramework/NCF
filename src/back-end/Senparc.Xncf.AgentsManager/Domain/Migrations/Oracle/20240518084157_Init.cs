            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    ChatGroupId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    FromAgentTemplateId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    ToAgentTemplateId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    FromChatGroupMemberId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    ToChatGroupMemberId = table.Column<int>(type: "NUMBER(10)", nullable: false),
