...
namespace Senparc.Service.SystemEntities
{
    ...
    /// <para>4、运行：PM> add-migration [更新名称] -Context SystemServiceEntities -o SystemEntities/Migrations/Migrations.Sqlite.SystemEntities</para>
    /// </summary> 
    public class SenparcDbContextFactory_SystemEntities :
        SenparcDesignTimeDbContextFactoryBase<SystemServiceEntities, Register>
    {
