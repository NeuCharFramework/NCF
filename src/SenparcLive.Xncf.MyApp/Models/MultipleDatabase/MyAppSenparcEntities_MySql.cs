...
namespace SenparcLive.Xncf.MyApp.Models.DatabaseModel
{
    ...
    public class MyAppSenparcEntities_MySql : MyAppSenparcEntities
    {
        public MyAppSenparcEntities_MySql(DbContextOptions<MyAppSenparcEntities_MySql> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2、运行：PM> add-migration [更新名称] -c MyAppSenparcEntities_MySql -o Migrations/Migrations.MySql </para>
    /// </summary>
    public class SenparcDbContextFactory_MySql : SenparcDesignTimeDbContextFactoryBase<MyAppSenparcEntities_MySql, Register>
    {
