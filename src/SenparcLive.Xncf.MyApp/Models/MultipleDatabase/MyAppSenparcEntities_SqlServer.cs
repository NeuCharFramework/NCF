...
namespace SenparcLive.Xncf.MyApp.Models.DatabaseModel
{
    ...
    public class MyAppSenparcEntities_SqlServer : MyAppSenparcEntities
    {
        public MyAppSenparcEntities_SqlServer(DbContextOptions<MyAppSenparcEntities_SqlServer> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2、运行：PM> add-migration [更新名称] -c MyAppSenparcEntities_SqlServer -o Migrations/Migrations.SqlServer </para>
    /// </summary>
    public class SenparcDbContextFactory_SqlServer : SenparcDesignTimeDbContextFactoryBase<MyAppSenparcEntities_SqlServer, Register>
    {
